...
module.exports = (robot) ->
  robot.hear /.+/, (msg) ->
    commands = ["list sonar projects","list sonar users","delete sonar user","create sonar user","delete sonar project","grant sonar","revoke sonar","help","create sonar project","reload" ,"create job","upload","give","restart jenkins","install","reload","jenkins list","jenkins build","start","delete job","install","restart jenkins","jenkins describe","help","setInstance","getAllInstance"]
    message = msg.message
